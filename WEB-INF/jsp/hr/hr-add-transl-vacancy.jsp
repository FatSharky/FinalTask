...
<fmt:message bundle="${locale}" key="locale.addVacancy.contractual"
	var="contractual" />
<fmt:message bundle="${locale}" key="locale.addVacancy.addTransl"
	var="addTransl" />
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<form class="form-horizontal" action="Controller" method="post">
					<input type="hidden" name="command" value="add-transl-vacancy">
					<input type="hidden" value="${requestScope.vacancy.idVacancy}"
						name="vacancy-id"> <input type="hidden" value="EN"
						name="translEN">
					<div class="form-group">
						...
						<div class="col-xs-6">
							<input type="text" class="form-control" name="vacancyName"
								placeholder="${enterVacancyName}" required maxlength="50">
							<c:choose>
					...
					<div class="form-group">
						...
						<div class="col-xs-6">
							<textarea class="form-control" rows="20" name="description"
					...
					<div class="form-group">
						<label class="control-label col-xs-2 col-md-1" for="duties">${duty}</label>
						<div class="col-xs-6">
