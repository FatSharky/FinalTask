...
import by.training.hrsystem.command.impl.hr.AddInterviewToApplicantCommand;
import by.training.hrsystem.command.impl.hr.AddMarkCommand;
import by.training.hrsystem.command.impl.hr.AddTranslVacancyCommand;
...
import by.training.hrsystem.command.impl.hr.DeleteInterviewCommand;
import by.training.hrsystem.command.impl.hr.DeleteInterviewMarkCommand;
import by.training.hrsystem.command.impl.hr.DeleteVacancyCommand;
import by.training.hrsystem.command.impl.hr.EditTranslVacancyCommand;
import by.training.hrsystem.command.impl.hr.EditVacancyCommand;
...
import by.training.hrsystem.command.impl.hr.ToAddTranslVacancyCommand;
import by.training.hrsystem.command.impl.hr.ToApplicantInerviewPageCommand;
import by.training.hrsystem.command.impl.hr.ToHrEditVacancyCommand;
...
import by.training.hrsystem.command.impl.hr.ToPassVerifyApplicantCommand;
import by.training.hrsystem.command.impl.hr.ToVerifyListCommand;
import by.training.hrsystem.command.impl.hr.VerifyResumeNotPassCommand;
import by.training.hrsystem.command.impl.hr.VerifyResumePassCommand;
