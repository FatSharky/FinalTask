...
public class EditTranslVacancyCommand implements Command {

	private static final Logger logger = LogManager.getLogger(EditTranslVacancyCommand.class);

	@Override
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		logger.debug("EditTranslVacancyCommand.execute() start");
		...
		logger.debug("EditTranslVacancyCommand.execute() end");
	}
}
